...
public class TestNGAnnotation extends ProjectSpecificMethod{
		...
		public void runSalesForce() {
			...
			WebElement LegalDD = driver.findElement(By.xpath("//span[contains(text(),'Legal Entities')]/following::span[contains(text(),'Legal Entities List')]"));
